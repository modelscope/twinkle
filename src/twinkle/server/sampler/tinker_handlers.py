...
class TinkerSamplerHandlers:
    """
    Mixin providing Tinker-compatible sampler endpoint.

    Expects the combined class to also inherit TaskQueueMixin and to have:
      self.sampler, self.state
    """

    @staticmethod
    def _register_tinker_sampler_routes(app: FastAPI):
