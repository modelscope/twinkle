...
class MegatronModelInitializer:
    ...
    def create_transformer_config(
        ...
        **overrides,
        ...
        optional_fields = {
            'num_query_groups': mg_config_dict.get('num_query_groups', mg_config_dict['num_attention_heads']),
            'ffn_hidden_size': mg_config_dict.get('ffn_hidden_size', 4 * mg_config_dict['hidden_size']),
            'num_moe_experts': mg_config_dict.get('num_experts'),
            'moe_router_topk': mg_config_dict.get('moe_router_topk', 2) if mg_config_dict.get('num_experts') else None,
        ...
        self._position_embedding_type = mg_config_dict.get('position_embedding_type', 'rope')
    ...
    def create_gpt_model(
        ...
        **config_overrides,
        ...
        if max_sequence_length is None:
            max_sequence_length = getattr(hf_config, 'max_position_embeddings', 4096)
    ...
    def load_from_hf(
        ...
        Uses swift's GPTBridge for maximum compatibility and stability.
        ...
        # Load weights using swift's bridge
