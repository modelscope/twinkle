...
from twinkle.megatron.args import get_args
from twinkle.megatron.model.constant import MegatronModelType, ModelType
from twinkle.megatron.model.gpt_bridge import GPTBridge, MultimodalGPTBridge
from twinkle.megatron.model.mm_gpt_model import MultimodalGPTModel
...
class Qwen3Omni_Vit(HuggingFaceModule):
    ...
    def _get_inputs_embeds(inputs_embeds, inputs, visual, processor, config):
        from twinkle.megatron.utils import split_cp_inputs
