...
def test_idempotent_dispatch():
    ...
    try:
        from twinkle.tracker import _hparams_dispatched, dispatch_hyperparams
        from twinkle.tracker import clear_trackers, list_trackers, register_tracker
        from twinkle.tracker import set_rank, SwanLabTracker
    except ImportError:
