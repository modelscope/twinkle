...
def create_countdown_dataset():
    ...
    dataset = Dataset(DatasetMeta('ms://zouxuhong/Countdown-Tasks-3to4', data_slice=range(500)))
    dataset.set_template('Template', model_id=f'ms://{BASE_MODEL}', max_length=8192)
...
def main():
    ...
    for batch in dataloader:
        ...
        if step % SYNC_INTERVAL == 0:
            ...
            sampling_client = (training_client.save_weights_and_get_sampling_client(name=f'grpo-step-{step}'))
        ...
        for seq in all_sequences:
            ...
            trajectories.append({'messages': [{'role': 'assistant', 'content': decoded_text}]})
        ...
        fwdbwd_future = training_client.forward_backward(training_data, 'importance_sampling')
