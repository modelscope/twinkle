...
device_mesh = DeviceMesh(device_type='cuda', mesh=np.array([[0, 1], [2, 3]]), mesh_dim_names=('dp', 'fsdp'))
...
def train():
    ...
    model = TransformersModel(
        model_id='ms://Qwen/Qwen2.5-7B-Instruct', remote_group='model', gradient_accumulation_steps=16)
