...
from twinkle.model import MegatronModel, MultiLoraMegatronModel
...
def train():
    ...
    model.set_lr_scheduler(
        scheduler_cls='default', lr_warmup_steps=5, lr_decay_steps=len(dataloader), adapter_name='default')
