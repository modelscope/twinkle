...
parser.add_argument('--ep_size', type=int, default=2, help='Expert parallel size')
parser.add_argument(
    '--etp_size', type=int, default=None, help='Expert Tensor Parallel size (default: None, derived from TP)')
parser.add_argument('--max_steps', type=int, default=100)
parser.add_argument('--micro_batch_size', type=int, default=1, help='Micro batch size per DP rank')
parser.add_argument('--num_gpus', type=int, default=4)
parser.add_argument(
    '--model', type=str, default='ms://Qwen/Qwen3-30B-A3B', help='MoE model path. Default: Qwen3-30B-A3B (128 experts)')
parser.add_argument(
    '--sequence_parallel',
    action='store_true',
    default=True,
